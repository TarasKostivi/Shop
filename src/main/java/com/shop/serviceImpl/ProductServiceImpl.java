...
public class ProductServiceImpl implements ProductService {
    ...
    public void save(Product product, int categoryId, MultipartFile multipartFile) throws Exception {
        imgValidator.validate((Source) multipartFile);
    ...
    public void validation(Product product) throws Exception {
        validator.validate((Source) product);
    }
    ...
    public void addToCart(int userId, int productId) {
        ...
        try {
            Order orderExits = orderDao.getNotPaidByUser(user);
            List<Product> products = orderExits.getProducts();
            products.add(product);
            orderExits.setProducts(products);
            orderDao.update(orderExits);
