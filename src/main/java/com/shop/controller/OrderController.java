...
public class OrderController {
    ...
    public String placeorder(Principal principal, @RequestParam("totalPrice") String totalPrice,
                             @RequestParam String shipping_first_name, @RequestParam String shipping_last_name,
                             @RequestParam String billing_card_number, @RequestParam String billing_first_name,
